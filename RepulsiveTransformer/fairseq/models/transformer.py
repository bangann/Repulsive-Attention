...
class TransformerModel(FairseqModel):
    ...
    def add_args(parser):
        ...
        parser.add_argument('--d_kernel_weight', type=float, help='the weight of d_kernel in svgd')
        parser.add_argument('--stepsize', type=float, help='stepsize')
        parser.add_argument('--beta', type=float, help='beta')
        parser.add_argument('--bayesian_method', type=str, choices=['None', 'svgd', 'sgld', 'spos'],
                            help='bayesian_method')
...
def base_architecture(args):
    ...
    args.d_kernel_weight = getattr(args, 'd_kernel_weight', 1)
    args.stepsize = getattr(args, 'stepsize', 1)
    args.beta = getattr(args, 'beta', 1)
    args.bayesian_method = getattr(args, 'bayesian_method', 'None')
