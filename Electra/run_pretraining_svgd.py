...
from model import modeling_svgd as modeling
from model import optimization_svgd as optimization
...
class PretrainingModel(object):
    ...
    def __init__(self, config: configure_pretraining.PretrainingConfig,
        ...
        # record attention heads for svgd
        configure_pretraining.PretrainingConfig.num_attention_heads = self._bert_config.num_attention_heads
