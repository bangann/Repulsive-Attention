...
class model(nn.Module):
  def __init__(self,args):
    ...
    self.attn = MultiHeadAttention(args.hsz,args.hsz,args.hsz,h=8,dropout_p=args.drop)
    ...
    if args.title:
      ...
      self.attn2 = MultiHeadAttention(args.hsz,args.hsz,args.hsz,h=8,dropout_p=args.drop)
